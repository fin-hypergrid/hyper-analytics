...
module.exports = function() {
    describe(test.module('DataSource'), function() {
        ...
        describe('when called', function() {
            it('takes two parameters', function() {
                DataSource.length.should.equal(2);
            });
            describe('with "new" (i.e., as a constructor)', function() {
                var DATA, DATA_MAX;
                beforeEach(function() {
                    DATA = [
                ...
                describe('with 1 parameter returns a value that', function() {
                    ...
                    describe('UNFILTERED DATA FUNCTIONS', function() {
                    ...
                    describe('FILTERED DATA FUNCTIONS', function() {
                    ...
                    test.method('buildIndex', 1, function() {
                        ...
                        describe('with predicate as 1st parameter,', function() {
